...
while True:
        ...
        print "Enter quantum numbers for n, l, m , m  in order"
        print "                                 l   s \n"
        n = input("What is the principal quantum number? ")
        l = input("What is the orbital quantum number? (s=0 p=1 d=2 f=3) ")
        m = input("What is the magnetic quantum number? ")
        s = input("What is the spin quantum number? (-1/2=paired +1/2=unpaired) ")
