...
print "Triangle Utility Pack v0.6b (Jan02)"
...
def gcdext(p,q):  # extended Eucidean algorithm
    if q == 0:
        return [p,1,0]
...
def tripack():
    ...
    def about():
        ...
        print "http://github.com/alltootechnical/PythonScripts/blob/master/triangle_utility_pack_0.6b.py"
        inp = raw_input ("\nPress [Enter] to go back")
